...
class OutputHandler:
    def __init__(self):
        ...
        self.dir = Path(config.base_dir) / config.get('output.directory', 'data/outputs')
        self.timestamp = datetime.utcnow().strftime(config.get('output.timestamp_format', '%Y%m%d_%H%M%S'))
